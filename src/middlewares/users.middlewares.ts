...
class UserValidation {
  public usernameValidation = (req: Request, res: Response, next: NextFunction) => {
  ...
  public classeValidation = (req: Request, res: Response, next: NextFunction) => {
  ...
  public levelValidation = (req: Request, res: Response, next: NextFunction) => {
